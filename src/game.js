...
class PlayerObject extends GameObject{
    ...
    paint(ctx) {
        ...
        this.reverted = this.angle > 90 && this.angle < 270;
        ctx.save();
...
class EnemyController {
    constructor(width, height) {
        ...
        this.enemyPlanes = [];
        this.enemyPlanes.push(new GameObject(this.width / 2 + 500 + 450, this.height / 2, 1024 / 4, 328 / 4, "img/bomberPlane", 6, false));
...
class GameArea {
    constructor (element, width, height, refreshRate, showHitboxes){
        this.width = width;
        this.height = height;
    ...
    redraw() {
        ...
        if(this.showHitboxes) {
            ...
            this.enemyController.paintHitboxes(this.ctx);
...
let gameArea = new GameArea(document.getElementById('game'), 1280, 720, 20, false);
gameArea.unpause();